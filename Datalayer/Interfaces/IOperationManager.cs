...
namespace Datalayer.Interfaces
{
    public interface IOperationManager
    {
        ...
        Task<ResponseHandler<NameValueDTO>> GetProjectCountByMethodology(int orgId, DashFilter filt);
        Task<ResponseHandler<NameValueDTO>> GetProjectCountByStatus(int orgId, DashFilter filt);
        Task<ResponseHandler<MethodologyMonthlyStatusDTO>> GetStatusCountByMonth(int orgId, DashFilter filt);
        Task<ResponseHandler<NameValueDTO>> GetProjectCountByCertification(int orgId, DashFilter filt);
        Task<ResponseHandler<NameValueDTO>> GetSavingsByCategory(int orgId, DashFilter filt);
        Task<ResponseHandler<MonthlySavingsDTO>> GetMonthlySavings(int orgId, DashFilter filt);
        Task<ResponseHandler<UserCompletedProjectsDTO>> GetCompletedProjectsByUserCI(int orgId, DashFilter filt);
