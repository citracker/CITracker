...
//        lightFn();
//        localStorage.setItem("spruhalandingHeader", 'light');
//        localStorage.setItem("spruhalandingMenu", 'light');
//    })
//    /* Light Layout End */
...
//        darkFn();
//        localStorage.setItem("spruhalandingMenu", 'dark');
//        localStorage.setItem("spruhalandingHeader", 'dark');
//    });
//    /* Dark Layout End */
...
//        localStorage.setItem("spruhalandingrtl", true);
//        localStorage.removeItem("spruhalandingltr");
//            rtlFn();
//    });
//    /* rtl end */
...
//        //    local storage
//        localStorage.setItem("spruhalandingltr", true);
//        localStorage.removeItem("spruhalandingrtl");
//        ltrFn();
//    });
//    /* ltr end */
...
function lightFn() {
    ...
    updateColors()
    localStorage.removeItem("spruhalandingdarktheme");
    checkOptions();
    html.style.removeProperty('--primary-rgb');
}
...
function darkFn() {
    ...
    updateColors()
    localStorage.setItem("spruhalandingdarktheme", true);
    localStorage.removeItem("spruhalandinglighttheme");
    checkOptions();
    html.style.removeProperty("--primary-rgb");
}
...
function checkOptions() {
    ...
    // dark
    if (localStorage.getItem('spruhalandingdarktheme')) {
        document.querySelector('#switcher-dark-theme').checked = true;
    }

    //RTL
    if (localStorage.getItem('spruhalandingrtl')) {
