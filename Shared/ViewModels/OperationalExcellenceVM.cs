...
{
    public class OperationalExcellenceVM
    {
        ...
        public ResponseHandler<OperationalExcellenceDTO> Projects { get; set; }
        public List<OperationalExcellenceMonthlySavingDTO> MonthlySavings { get; set; }
    }
}
